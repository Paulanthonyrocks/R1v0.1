...
# Kafka Configuration
KAFKA_BROKERS = os.getenv("KAFKA_BROKERS", "dummy_kafka:9092").split(
    ","
...
MONGO_RETRY_DELAY_SECONDS = int(
    os.getenv("MONGO_RETRY_DELAY_SECONDS", 2)
...
SENSOR_TO_REGION_MAPPING = {
    "sensor_1": "north_region",
    "sensor_2": "north_region",
    "sensor_3": "south_region",
    "sensor_4": "south_region",
...
FORCE_WINDOW_CHECK_INTERVAL_SECONDS = int(
    os.getenv("FORCE_WINDOW_CHECK_INTERVAL_SECONDS", 10)
)
