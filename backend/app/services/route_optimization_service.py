...
class RouteOptimizationService:
    ...
    async def get_optimized_route(
        ...
        try:
            ...
            adjusted_preferences = self._adjust_preferences_for_conditions(
                preferences or {}, weather_impact, event_impacts
            )
            ...
            route = self.optimizer.optimize_route(
                ...
                consider_alternatives=adjusted_preferences.get(
    ...
    def _format_route_response(
        ...
        return {
            ...
            "confidence_score": self._calculate_confidence_score(
                route, weather_impact, event_impacts
            ),
        }
    ...
    def _calculate_confidence_score(
        ...
        event_impacts: Optional[List[Dict[str, Any]]],
    ) -> float:
        ...
        if event_impacts:
            high_severity_events = sum(
                1 for e in event_impacts if e["severity"] == "High"
            )
