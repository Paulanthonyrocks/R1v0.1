            ...
            if self.db_queue and data.get("speed") is not None:
                try:
                    ...
                    self.db_queue.put_nowait({
                        ...
                        "ground_centroid": [float(x) for x in data.get("ground_centroid")] if data.get("ground_centroid") else None,
                        ...
                        "estimated_pixels_per_meter": float(data.get("estimated_pixels_per_meter")) if data.get("estimated_pixels_per_meter") else None,
                        "direction": str(data.get("direction", "N/A")),
                        "acceleration": float(data.get("acceleration")) if data.get("acceleration") is not None else None,
                        "embedding": data.get("embedding") if data.get("new_embedding") else None,
                        "car_model": data.get("car_model"),
                        "car_model_confidence": float(data.get("car_model_confidence")) if data.get("car_model_confidence") is not None else None,
                    })
