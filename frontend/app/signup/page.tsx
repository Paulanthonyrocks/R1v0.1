    ...
    <div className="bg-lcd-bg text-lcd-text font-lcd flex flex-col min-h-screen w-full">
      ...
      <header className="flex items-center justify-between px-4 py-1 border-b-2 border-lcd-text">
        <div className="flex items-center space-x-2">
          <Signal size={20} />
          <span className="font-lcd matrix-glow">SIGN UP</span>
        </div>
        <div className="flex items-center space-x-2">
          <Clock size={20} />
      ...
      <div className="flex items-center justify-center flex-1">
        <div className="matrix-glow-card p-8 max-w-sm w-full">
          <h1 className="text-2xl font-bold mb-6 text-center uppercase text-lcd-text tracking-normal">Sign Up</h1> {/* Added tracking-normal */}
          <form onSubmit={handleSignup}>
            ...
            <div className="mb-6">
              <label className="block text-sm font-semibold mb-2 text-lcd-text tracking-normal" htmlFor="confirmPassword"> {/* Added text-lcd-text tracking-normal */}
                Confirm Password
              </label>
              <input
                type="password"
          ...
          <p className="text-center text-sm mt-4 tracking-normal"> {/* Added tracking-normal */}
            ...
            <a href="/login" className="text-lcd-text hover:underline tracking-normal font-lcd"> {/* Added tracking-normal */}
              Login
            </a>
          </p>
        </div>
